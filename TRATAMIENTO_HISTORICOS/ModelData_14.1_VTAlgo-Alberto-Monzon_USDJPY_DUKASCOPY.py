...
symbol = 'USDJPY'  # Define el símbolo aquí
proveedor = "DUKASCOPY"
tipo_gap = "Gap_Temp"
...
file_work = '2016_2024.11.3USDJPY-M1-DUKASCOPY.csv'
#file_work = 'tradestation.txt'

file_main = 'C:/DataForex_Prueba/'  # Ruta principal de trabajo
...
scatter_fig.update_layout(title='Scatter Plot of Time Gaps (Time_Diff) in USD/JPY Data',
